...
>>>>>>> 8479cd2ce647dae486d1d39a30d0caf98d1f1231
          ...
          <nav className="footer-links">
            <ul>
              ...
              <li><a href="#">Derechos de Usuario</a></li>
              <li><img src="/src/assets/img/bembos.svg" alt="Logo Bembos" id="logo-bembos" /></li>
            </ul>
          </nav>
          ...
          <div className="newsletter">
            ...
            <div className="terms-checkbox">
              <input type="checkbox" id="accept-terms" />
              <label htmlFor="accept-terms" className="terms-label">He leído y acepto los términos</label>
            </div>
            <a href="#"><img src="/src/assets/img/reclamaciones.jpg" alt="Libro de Reclamaciones" className="complaints-img" /></a>
          </div>
