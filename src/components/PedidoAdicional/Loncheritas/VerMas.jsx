...
const Complementos = () => {
  ...
  useEffect(() => {
    const fetchComplementos = async () => {
      try {
        const response = await fetch("http://localhost:3000/complementos"); // Adjust URL if necessary
  ...
  return (
    <div className="pedidoContainer">
      <div class="breadcrumb">
        ...
        <a href="#">Family Box Piqueo</a>
      </div>

      <form className="producto-info">
        <div className="producto-container">
          <div class="producto-image">
            <img
              src="https://d31npzejelj8v1.cloudfront.net/media/catalog/product/8/0/800x800-piqueo-agosto-bb.webp"
          ...
          <div className="producto-details">
            <h1 class="producto-title">
              <strong>Loncherita Nuggets</strong>
            </h1>
            <h2 class="producto-description">
              Disfruta de una deliciosa Loncherita de Nuggets a que incluye:
              Nuggets x4 , papa regular, frugos y un helado mini princesa.
            </h2>

            <div class="extraS-header" onclick="toggleExtraSContainer()">
              <span class="extraS-header-number">3</span>
              <p class="extraS-header-text">¿Desea Salsas Extras?</p>
              ...
              <button class="product-button">
                <div class="product-image-container bordered">
                  <span class="product-image">
                    <img
                      src="https://www.bembos.com.pe/_nuxt/img/all-salsa.ab23071.svg"
                      width="72"
                      height="72"
                      alt="Todas Las Salsas"
                      loading="lazy"
                    />
                  </span>
                </div>
              ...
              <div class="product-item">
                <button class="product-button">
                  <div class="product-image-container">
                    <span class="product-image">
                      <img
                        src="https://d31npzejelj8v1.cloudfront.net/media/catalog/product/k/e/ketchup_2.webp"
                        width="72"
                        height="72"
              ...
              <div class="product-item">
                <button class="product-button">
                  <div class="product-image-container">
                    <span class="product-image">
                      <img
                        src="https://d31npzejelj8v1.cloudfront.net/media/catalog/product/m/a/mayonesa_3_2.webp"
                        width="72"
                        height="72"
                        alt="Mayonesa"
                        loading="lazy"
              ...
              <div class="product-item">
                <button class="product-button">
                  <div class="product-image-container">
                    <span class="product-image">
                      <img
                        src="https://d31npzejelj8v1.cloudfront.net/media/catalog/product/a/j/aji_2_1.webp"
                        width="72"
                        height="72"
                        alt="Mayonesa"
                        loading="lazy"
            ...
            <div class="extra-header" onclick="toggleExtraContainer()">
              ...
              <p class="extra-header-text">¿Desea Un Complemento?</p>
              <span class="toggle-icon">▼</span>
            </div>
            ...
            <div
              class="salsaFav-header open"
              onclick="toggleSalsaFavContainer()"
            >
              <span class="salsaFav-header-number">1</span>
              <p class="salsaFav-header-text">Desea Elegir Salsas</p>
              <span class="toggle-icon">▼</span>
            </div>
