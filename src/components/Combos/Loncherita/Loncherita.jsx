            ...
            <div className="contenido">
              <div className="descripcion">
                ...
                <p className="descripcion-txt">
                  Las loncheritas infantiles son una opción ideal para los más chicos. Puedes pedir tu loncherita Bembos
                  con hamburguesa o nuggets, y te incluye papas fritas y bebida.
                </p>
              </div>
            </div>
          </div>
